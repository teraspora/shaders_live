...
void main(void) {
    float numPoints = 0.04;
    float scale =  2. * nmouse().x;
...
// =======================================================================
    ...
    vec2 friz = vec2(5. * sin(t * uv.x), 16. * cos(t * uv.y));
    vec2 vel = vec2(1., 10.);
    ...
    for (float i = 0.; i < numPoints; i++) {
        ...
        float d = minkd(uv, p, 0.999999971);
